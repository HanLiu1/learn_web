...
var FieldRadio = function FieldRadio(_ref, ref) {
  ...
  if (mode === 'edit') {
    ...
    var RadioComponents = radioType === 'button' ? _antd.Radio.Button : _antd.Radio;

    var _dom = /*#__PURE__*/_react.default.createElement(_antd.Radio.Group, (0, _extends2.default)({
      ref: radioRef
    }, rest.fieldProps, {
