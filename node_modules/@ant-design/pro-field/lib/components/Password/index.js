...
var FieldPassword = function FieldPassword(_ref, ref) {
  ...
  if (mode === 'read') {
    ...
    if (text) {
      dom = /*#__PURE__*/_react.default.createElement(_antd.Space, null, /*#__PURE__*/_react.default.createElement("span", {
        ref: ref
  ...
  if (mode === 'edit' || mode === 'update') {
    var _dom = /*#__PURE__*/_react.default.createElement(_antd.Input.Password, (0, _extends2.default)({
