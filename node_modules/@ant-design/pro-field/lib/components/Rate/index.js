...
var FieldRate = function FieldRate(_ref, ref) {
  ...
  if (mode === 'read') {
    var dom = /*#__PURE__*/_react.default.createElement(_antd.Rate, (0, _extends2.default)({
      allowHalf: true,
      disabled: true,
      ref: ref
    }, fieldProps, {
  ...
  if (mode === 'edit' || mode === 'update') {
    var _dom = /*#__PURE__*/_react.default.createElement(_antd.Rate, (0, _extends2.default)({
      allowHalf: true,
      ref: ref
    }, fieldProps));
