  ...
  if (type === 'edit' || type === 'update') {
    var _dom = /*#__PURE__*/_react.default.createElement(InputNumberPopover, (0, _extends2.default)({
      content: function content(props) {
        ...
        var localeText = getTextByLocale(moneySymbol ? locale : false, props.value.toString().replace(reg, ','), precision, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, numberFormatOptions), {}, {
          notation: 'compact'
        }));
