...
var proFieldParsingText = function proFieldParsingText(text, valueEnumParams) {
  if (Array.isArray(text)) {
    return /*#__PURE__*/_react.default.createElement(_antd.Space, null, text.map(function (value) {
      return (
        /*#__PURE__*/
        // @ts-ignore
...
var useFieldFetchData = function useFieldFetchData(props) {
  ...
  var _useSWR = (0, _swr.default)([key, props.params, keyWords], function (_, params, kw) {
...
var FieldSelect = function FieldSelect(props, ref) {
  ...
  if (mode === 'read') {
    ...
    var optionsValueEnum = (options === null || options === void 0 ? void 0 : options.length) ? options === null || options === void 0 ? void 0 : options.reduce(function (pre, cur) {
      return (0, _objectSpread3.default)((0, _objectSpread3.default)({}, pre), {}, (0, _defineProperty2.default)({}, cur.value, cur.label));
  ...
  if (mode === 'edit' || mode === 'update') {
    var renderDom = function renderDom() {
      ...
      return /*#__PURE__*/_react.default.createElement(_SearchSelect.default, (0, _extends2.default)({
        ...
        ref: inputRef,
        allowClear: true,
        notFoundContent: loading ? /*#__PURE__*/_react.default.createElement(_antd.Spin, {
          size: "small"
