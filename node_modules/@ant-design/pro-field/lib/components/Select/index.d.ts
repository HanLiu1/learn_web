...
import './index.less';
declare type SelectOptionType = OptionsType;
 ...
 * @param valueEnum
 */
export declare const proFieldParsingValueEnumToArray: (valueEnumParams: ProFieldValueEnumType) => {
    value: string | number;
    text: string;
}[];
export declare const useFieldFetchData: (props: FieldSelectProps & {
    proFieldKey?: React.Key;
}) => [boolean, OptionsType, (keyWord?: string | undefined) => void, () => void];
declare const _default: React.ForwardRefExoticComponent<import("@ant-design/pro-provider").BaseProFieldFC & import("@ant-design/pro-provider").ProRenderFieldPropsType & FieldSelectProps<any> & React.RefAttributes<any>>;
