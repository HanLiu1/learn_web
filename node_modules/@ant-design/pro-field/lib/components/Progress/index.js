...
var FieldProgress = function FieldProgress(_ref, ref) {
  ...
  if (mode === 'read') {
    var dom = /*#__PURE__*/_react.default.createElement(_antd.Progress, (0, _extends2.default)({
      ref: ref,
      size: "small",
      style: {
        minWidth: 100,
  ...
  if (mode === 'edit' || mode === 'update') {
    var _dom = /*#__PURE__*/_react.default.createElement(_antd.InputNumber, (0, _extends2.default)({
      ref: ref,
