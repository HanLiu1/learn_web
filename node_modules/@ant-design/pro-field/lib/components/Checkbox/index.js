...
var FieldCheckbox = function FieldCheckbox(_ref, ref) {
  ...
  if (mode === 'read') {
    ...
    return /*#__PURE__*/_react.default.createElement(_antd.Space, null, dom);
  }

  if (mode === 'edit') {
    var _rest$fieldProps;

    var _dom = /*#__PURE__*/_react.default.createElement(_antd.Checkbox.Group, (0, _extends2.default)({}, rest.fieldProps, {
