...
var defaultRenderText = function defaultRenderText(text, valueType, props, valueTypeMap) {
  ...
  if (customValueTypeConfig) {
    ...
    if (mode === 'read') {
      ...
      return (_customValueTypeConfi = customValueTypeConfig.render) === null || _customValueTypeConfi === void 0 ? void 0 : _customValueTypeConfi.call(customValueTypeConfig, text, (0, _objectSpread2.default)((0, _objectSpread2.default)({
        text: text
      }, props), {}, {
        mode: mode || 'read'
    ...
    if (mode === 'update' || mode === 'edit') {
      ...
      return (_customValueTypeConfi2 = customValueTypeConfig.renderFormItem) === null || _customValueTypeConfi2 === void 0 ? void 0 : _customValueTypeConfi2.call(customValueTypeConfig, text, (0, _objectSpread2.default)({
        text: text
  ...
  if (valueType === 'avatar' && typeof text === 'string' && props.mode === 'read') {
    return /*#__PURE__*/_react.default.createElement(_antd.Avatar, {
      src: text,
      size: 22,
      shape: "circle"
    });
...
var ProField = function ProField(_ref, ref) {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, defaultRenderText((_ref2 = text !== null && text !== void 0 ? text : fieldProps === null || fieldProps === void 0 ? void 0 : fieldProps.value) !== null && _ref2 !== void 0 ? _ref2 : '', valueType || 'text', (0, _objectSpread2.default)((0, _objectSpread2.default)({
    ref: ref
  }, rest), {}, {
    mode: rest.mode || 'read',
