...
function useEditableArray(props) {
  ...
  var onValuesChange = function onValuesChange(value, values) {
    ...
    editableKeys.forEach(function (eachRecordKey) {
      ...
      if (!editRow) {
        ...
        editRow = (0, _get.default)(values, [props.tableName || '', recordKey].flat(1).filter(function (key) {
          return key || key === 0;
        }));
      }
  ...
  var actionRender = function actionRender(row, form) {
    ...
    var config = {
      ...
      onCancel: function () {
        var _onCancel = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4(recordKey, editRow, originRow, newLine) {
          var _props$onCancel;
      ...
      onDelete: function () {
        var _onDelete = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5(recordKey, editRow) {
          var _props$onDelete;
      ...
      onSave: function () {
        var _onSave = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6(recordKey, editRow, originRow, newLine) {
          var _props$onSave;
