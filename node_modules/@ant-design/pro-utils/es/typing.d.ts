 ...
 * @param color 颜色选择器
 */
export declare type ProFieldValueType = 'text' | 'password' | 'money' | 'textarea' | 'option' | 'date' | 'dateWeek' | 'dateMonth' | 'dateQuarter' | 'dateYear' | 'dateRange' | 'dateTimeRange' | 'dateTime' | 'time' | 'timeRange' | 'select' | 'checkbox' | 'rate' | 'radio' | 'radioButton' | 'index' | 'indexBorder' | 'progress' | 'percent' | 'digit' | 'second' | 'avatar' | 'code' | 'switch' | 'fromNow' | 'image' | 'jsonCode' | 'cascader' | 'color';
...
export declare type ProSchema<Entity = Record<string, any>, ExtraProps = unknown, ComponentsType = ProSchemaComponentTypes, ValueType = 'text', ExtraFormItemProps = unknown> = {
     ...
     * @name 标题
     */
    title?: ((schema: Omit<ProSchema<Entity, ExtraProps>, 'render' | 'renderFormItem'>, type: ComponentsType, dom: React.ReactNode) => React.ReactNode) | React.ReactNode;
