...
function StepsForm(props) {
  ...
  }, /*#__PURE__*/_react.default.createElement(_antd.Steps, (0, _extends2.default)({}, stepsProps, {
    current: step,
    onChange: undefined
  }), formArray.map(function (item) {
    var itemProps = formMapRef.current.get(item);
    return /*#__PURE__*/_react.default.createElement(_antd.Steps.Step, (0, _extends2.default)({
      key: item,
  ...
  var next = submitter !== false && /*#__PURE__*/_react.default.createElement(_antd.Button, (0, _extends2.default)({
    key: "next",
    type: "primary",
    loading: loading
  ...
  var pre = submitter !== false && /*#__PURE__*/_react.default.createElement(_antd.Button, (0, _extends2.default)({
    key: "pre"
  ...
  var submit = submitter !== false && /*#__PURE__*/_react.default.createElement(_antd.Button, (0, _extends2.default)({
    key: "submit",
    type: "primary",
    loading: loading
  }, submitter === null || submitter === void 0 ? void 0 : submitter.submitButtonProps, {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: prefixCls
  }, /*#__PURE__*/_react.default.createElement(_antd.Form.Provider, rest, /*#__PURE__*/_react.default.createElement(StepsFormProvide.Provider, {
    value: {
      loading: loading,
    ...
    className: "".concat(prefixCls, "-container"),
    style: containerStyle
  }, formDom, /*#__PURE__*/_react.default.createElement(_antd.Space, null, renderSubmitter()))))));
}
