...
var QueryFilterContent = function QueryFilterContent(props) {
  ...
  var doms = flatMapItems(items, props.ignoreRules).map(function (item, index) {
    ...
    var colItem = /*#__PURE__*/_react.default.createElement(_antd.Col, {
      key: itemKey,
      span: colSpan
    }, item);

    if (split && currentSpan % 24 === 0 && index < itemLength - 1) {
      return [colItem, /*#__PURE__*/_react.default.createElement(_antd.Col, {
        span: "24",
        key: "line"
  ...
  }, doms, submitter && /*#__PURE__*/_react.default.createElement(_antd.Col, {
    key: "submitter",
    span: spanSize.span,
    offset: offset,
    style: {
